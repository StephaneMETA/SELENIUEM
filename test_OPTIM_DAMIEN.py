...
class Test(unittest.TestCase):
    ...
    def test_(self):
        ...
        #     # Accumuler le total
        #     total_count_avant += count_on_page

        #     print(f'Page actuelle: {count_on_page} éléments sur la premiere page | Total jusqu à présent: {total_count_avant} éléments')
        ...
        driver.find_element(By.NAME,"firstName").send_keys("Peta")
        driver.find_element(By.NAME,"middleName").click()
        driver.find_element(By.NAME,"middleName").clear()
        driver.find_element(By.NAME,"middleName").send_keys("Ouchnok")
        driver.find_element(By.NAME,"lastName").click()
        driver.find_element(By.NAME,"lastName").clear()
        driver.find_element(By.NAME,"lastName").send_keys("Trifoulli")
        ...
        while True:
            ...
            print(f'\nPage actuelle: {count_on_page} éléments sur la premiere page | Total jusqu à présent: {total_count} éléments')
        ...
        self.assertNotEqual(total_count, 76)
        #self.assertNotEqual(total_count, total_count_avant+1)
